                                ...
                                @foreach ($note->todo as $todo)
                                    ...
                                    !important;">
                                        ...
                                        <div class="col-xxl-3 col-12 mt-3 mt-xxl-0">
                                            <span class="badge bg-success mb-2 align-self-start w-100">{{{ date("d-m-Y", strtotime($todo->todo_deadline)) }}}</span>
