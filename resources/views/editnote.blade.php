                        ...
                        <div class="container px-4 px-lg-5">
                            ...
                            <div class="row gx-4 gx-lg-5">
                                ...
                                <div class="bg-dark text-white">
                                    <div class="my-5 mx-4">
                                        <h2 class="my-3 text-center">Edit Note</h2>

                                        <div class="row input-group-newsletter form-signup">

                                            <form method="POST" action="{{ route('updatenote', $note->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('put')
                                                ...
                                                <div class="form-group my-3">
                                                    ...
                                                    <input type="text" name="name" id="name" class="form-control"
                                                        placeholder="enter name..."value="{{ $note->name }}">
                                                </div>

                                                <div class="form-group my-3">
                                                    <label for="description">Description</label>
                                                    <input type="text" name="description" id="description"
                                                        class="form-control" placeholder="description..." value="{{ $note->description }}">
                                                </div>
